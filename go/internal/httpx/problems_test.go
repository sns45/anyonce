...
func TestProblems(t *testing.T) {
	t.Run("REQ-HTTP-13: every code maps to its D11 status", func(t *testing.T) {
		want := map[httpx.Code]int{httpx.CodeMissingKey: 400, httpx.CodeInvalidKey: 400, httpx.CodeConflict: 409, httpx.CodeFingerprintMismatch: 422, httpx.CodePayloadTooLarge: 413, httpx.CodeStoreUnavailable: 503, httpx.CodeMissingPrincipal: 500}
